...
class PagaPlot(PlotBase):
    ...
    def _compute_pos(
        ...
        #adjacency = stereo_exp_data.tl.result['paga']['connectivities']
        
        #if adj_tree == 'connectivities_tree':
        #    adj_tree = stereo_exp_data.tl.result['paga']['connectivities_tree']
        ...
        #stereo_exp_data.tl.result['paga']['pos'] = pos_array
        return pos_array
