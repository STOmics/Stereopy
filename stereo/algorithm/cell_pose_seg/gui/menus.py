...
def mainmenu(parent):
    ...
    load_manual = QAction("Load &processed/labelled image (*_seg.npy)", parent)
    load_manual.setShortcut("Ctrl+P")
    load_manual.triggered.connect(lambda: io._load_seg(parent))
    file_menu.addAction(load_manual)
