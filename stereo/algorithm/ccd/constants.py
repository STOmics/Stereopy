COMMUNITY_DETECTION_DEFAULTS = {
    ...
    'verbose': 0,
    # Save plots flag. 0 - No plotting/saving, 1 - save clustering plot, 2 - additionally save plots of cell type images statistics and cell mixture plots, # noqa
    ...
    # 4 - additionally save cell type images, abundance plots and cell percentage table for each slice, 5 - additionally save color plots. # noqa
    'plotting': 5,
    # Project name that is used to name a directory containing all the slices used.
    'project_name': "community",
    # Skip statistics calculation on cell community clustering result. A table of cell mixtures and comparative spatial plots of cell types and mixtures will not be created. # noqa
    'skip_stats': False,
    ...
    'min_perc_to_show': 4,
    # Minimum number of cell types that have more than `min_perc_celltype` in a cluster, for a cluster to be shown in plot_celltype_table(). # noqa
    'min_num_celltype': 1,
    # Minimum percentage of cells of a cell type which at least min_num_celltype cell types need to have to show a cluster in plot_celltype_table(). # noqa
    ...
    'save_adata': False,
    # Minimum number of cells per cell type needed to use the cell type for cell communities extraction (in percentages). # noqa
