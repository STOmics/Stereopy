...
class GetMicroEnvs:
    ...
    def main(self,
        ...
        write_to_file(subgroups_by_thrshold,
                      'split_by_different_threshold', output_path=output_path, output_format='csv')

        return final_mst, pairwise_kl_df, output_path

    # FIXME: change the default output path
    def generate_micro_envs(self,
                            method,
