...
def _read_and_parse(dir, spatial_col, ty_col):
    """
...
def _test():
    ...
    ty_col = 'annotation'
    xli, yli, zli, tyli = _read_and_parse(dir, spatial_col, ty_col)

    # pl = pv.Plotter()

    # 2. 计算mesh
    tdg = ThreeDimGroup(xli, yli, zli, tyli, ty_name='CNS', eps_val=2,  min_samples=5, thresh_num=10)  # 1.5, 8
