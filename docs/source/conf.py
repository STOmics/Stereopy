...
nbsphinx_thumbnails = {
	...
	"Tutorials/Cell_Cell_Communication": "_static/Cell_Cell_Communication_Circos.png",
    ...
    "Tutorials(Multi-sample)/Batch_QC": "_static/BatchQC.png",
    "Tutorials(Multi-sample)/Comparative_Analysis": "_static/Comparative_Analysis.png",
    "Tutorials(Multi-sample)/Time_Series_Analysis": "_static/Time_Series_Analysis.png",
}
