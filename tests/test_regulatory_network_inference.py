...
class TestRegulatoryNetworkInference(unittest.TestCase):
    ...
    def test_example_regulatory_network_inference(self):
        ...
        self.test_data.plt.grn_dotplot(self.test_data.tl.result['leiden'],network_res_key='regulatory_network_inference', out_path=TEST_IMAGE_PATH + "grn_dotplot.png")
        ...
        self.test_data.plt.auc_heatmap_by_group(network_res_key='regulatory_network_inference',celltype_res_key='leiden',top_n_feature=5, out_path=TEST_IMAGE_PATH + "auc_heatmap_by_group.png")